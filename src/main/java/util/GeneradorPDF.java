...
public class GeneradorPDF {
    ...
    public static void generaPDFVenta(VentaRepuesto venta, String rutaArchivo) {
        try {
...
// Agregar filas con checkbox simulados
            ...
            for (DetalleRetiro d : venta.getNotaRetiro().getDetallesRetiro()) {
                BigDecimal subtotal = d.getRepuesto().getPrecio().multiply(new BigDecimal(d.getCantidad()));
                ...
                table.addCell(new PdfPCell(new Phrase(String.valueOf(d.getCantidad()), smallFont)));
...
// Agregar al documento
            ...
            document.close();
            JOptionPane.showMessageDialog(null, "Factura creado exitosamente en:\n" + rutaArchivo);
        } catch (Exception e) {
            e.printStackTrace();
        }
